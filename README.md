...
| قابلیت | کجاست |
|---|---|
| 🔐 **قفل + اثر انگشت/چهره** | تنظیمات ← قفل و امنیت (روی گوشی با حسگر، باز کردن بیومتریک) |
| 🎨 **پوسته تیره/روشن/سیستم + شیشه‌ای** | تنظیمات ← زبان و نمایش ← پوسته + «افکت شیشه‌ای» |
| ☁️ **همگام‌سازی خودکار** | تنظیمات ← همگام‌سازی ابری ← «ذخیره خودکار بعد از هر تغییر» و «دریافت خودکار» — هر تغییر چند ثانیه بعد روی گیت ذخیره و روی همه‌ی دستگاه‌ها یکی می‌شود |
| 🤖 **ایجنت‌های AI واقعی** | تنظیمات ← هوش مصنوعی ← کلید OpenAI (یا Groq) — بعد ایجنت‌ها واقعاً اجرا می‌شوند |
| 📈 **تشخیص خودکار فالوور/بیو** | در فرم رسانه/شبکه‌های اجتماعی دکمه‌ی «پر کردن خودکار» + دکمه‌ی تازه‌سازی در صفحه‌ی ماژول (اینستاگرام نیاز به واسط رایگان دارد — راهنما داخل برنامه) |
| 🧭 **آموزش و تور معرفی** | منوی کناری ← «راهنما» — تور قدم‌به‌قدم + نقشه‌ی ویرایش روی گیت‌هاب |
| 📐 **رفع منوی کشویی تمام‌صفحه‌ی اندروید** | منوهای کشویی حالا داخل خود برنامه باز می‌شوند |
| 🏢 **ساخت دپارتمان آسان‌تر** | تنظیمات ← دپارتمان‌ها ← «از قالب بسازید» (پادکست، دوره، انبار، بلاگ، لید) |
