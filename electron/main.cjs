  ...
  const template = [
    ...
    },
    {
      ...
      submenu: [
        ...
        { label: 'شبکه‌های اجتماعی', accelerator: 'CmdOrCtrl+4', click: () => go('/social') },
        { label: 'هوش مصنوعی', accelerator: 'CmdOrCtrl+5', click: () => go('/automation') },
        { label: 'کارها', accelerator: 'CmdOrCtrl+6', click: () => go('/m/tasks') },
