/**
 * تبدیل تاریخ میلادی ↔ شمسی (الگوریتم استاندارد جلالی، بدون هیچ وابستگی).
 * ذخیره‌سازی همیشه میلادی و به شکل YYYY-MM-DD است؛ این ماژول فقط برای نمایش و تقویم است.
 */
...
/** روزهای هفته با شروع از شنبه (چیدمان تقویم ایرانی) */
export const JALALI_DOW = ['ش', 'ی', 'د', 'س', 'چ', 'پ', 'ج']

/** تبدیل 'YYYY-MM-DD' میلادی به شمسی */
...
/** تبدیل شمسی به 'YYYY-MM-DD' میلادی */
