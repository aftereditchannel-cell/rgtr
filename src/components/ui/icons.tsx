...
import {
  ...
  Command, Compass, Contact, Copy, CornerDownLeft, Cpu, CreditCard, Crown, Delete, LockOpen,
  ChevronDown, ChevronUp, Database, DatabaseBackup, Disc3, DollarSign, Download, ExternalLink, Eye, EyeOff, HelpCircle, Fingerprint, BookOpen, BookMarked, BotMessageSquare,
...
export function PlatformIcon({ platform, size = 16, className = '', style }: { platform: string; size?: number; className?: string; style?: CSSProperties }) {
  ...
  return <ICONS.Link2 size={size} className={className} style={style} />
}
